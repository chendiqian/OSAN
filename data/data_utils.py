...
def edge_index2dense_adj(edge_index: Tensor, num_nodes: Optional[int] = None, default_dtype: torch.dtype = torch.int):
    """
    ...
    adj = torch.zeros(num_nodes, num_nodes, device=edge_index.device, dtype=default_dtype)
