...
class NetGCN(torch.nn.Module):
    def __init__(self, input_dim, edge_features, hid_dim, emb_dim):
        ...
        self.params_list.append({'params': self.conv1.parameters()})
        ...
        self.params_list.append({'params': self.conv2.parameters()})
        ...
        self.params_list.append({'params': self.conv3.parameters()})
