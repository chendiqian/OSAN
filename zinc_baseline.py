...
for _ in range(5):
    ...
    with open(osp.join('datasets', 'indices', 'train_indices.pkl'), 'rb') as handle:
        train_indices = pickle.load(handle)[:32]

    with open(osp.join('datasets', 'indices', 'test_indices.pkl'), 'rb') as handle:
        test_indices = pickle.load(handle)[:32]

    with open(osp.join('datasets', 'indices', 'val_indices.pkl'), 'rb') as handle:
